import{d as p,f as x}from"./index-C83YT7TH.js";import{u as c}from"./index-2XkZtR-9.js";import"./iframe-DLQ95NnL.js";import"../sb-preview/runtime.js";import"./index-CcisS4Rv.js";import"./index-DXimoRZY.js";import"./index-DrFu-skq.js";var h={exports:{}},a={};/**
 * @license React
...
interactive reference documentation from your components and stories.`}),e.jsxs("a",{href:"https://storybook.js.org/docs/vue3/writing-docs/autodocs",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:B,alt:"A browser window showing a Storybook being published to a chromatic.com URL"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Publish to Chromatic"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Publish your Storybook to review and collaborate with your entire team."}),e.jsxs("a",{href:"https://storybook.js.org/docs/vue3/sharing/publish-storybook#publish-storybook-with-chromatic",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:U,alt:"Windows showing the Storybook plugin in Figma"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Figma Plugin"}),e.jsx("p",{className:"sb-section-item-paragraph",children:`Embed your stories into Figma to cross-reference the design and live
implementation in one place.`}),e.jsxs("a",{href:"https://storybook.js.org/docs/vue3/sharing/design-integrations#embed-storybook-in-figma-with-the-plugin",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:F,alt:"Screenshot of tests passing and failing"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Testing"}),e.jsx("p",{className:"sb-section-item-paragraph",children:`Use stories to test a component in all its variations, no matter how
complex.`}),e.jsxs("a",{href:"https://storybook.js.org/docs/vue3/writing-tests",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:L,alt:"Screenshot of accessibility tests passing and failing"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Accessibility"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Automatically test your components for a11y issues as you develop."}),e.jsxs("a",{href:"https://storybook.js.org/docs/vue3/writing-tests/accessibility-testing",target:"_blank",children:["Learn more",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:S,alt:"Screenshot of Storybook in light and dark mode"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Theming"}),e.jsx("p",{className:"sb-section-item-paragraph",children:"Theme Storybook's UI to personalize it to your project."}),e.jsxs("a",{href:"https://storybook.js.org/docs/vue3/configure/theming",target:"_blank",children:["Learn more",e.jsx(t,{})]})]})]})})]}),`
...
`,e.jsxs("div",{className:"sb-section sb-socials",children:[e.jsxs("div",{className:"sb-section-item",children:[e.jsx("img",{src:R,alt:"Github logo",className:"sb-explore-image"}),e.jsx(s.p,{children:"Join our contributors building the future of UI development."}),e.jsxs("a",{href:"https://github.com/storybookjs/storybook",target:"_blank",children:["Star on GitHub",e.jsx(t,{})]})]}),e.jsxs("div",{className:"sb-section-item",children:[e.jsx("img",{src:v,alt:"Discord logo",className:"sb-explore-image"}),e.jsxs("div",{children:[e.jsx(s.p,{children:"Get support and chat with frontend developers."}),e.jsxs("a",{href:"https://discord.gg/storybook",target:"_blank",children:["Join Discord server",e.jsx(t,{})]})]})]}),e.jsxs("div",{className:"sb-section-item",children:[e.jsx("img",{src:y,alt:"Youtube logo",className:"sb-explore-image"}),e.jsxs("div",{children:[e.jsx(s.p,{children:"Watch tutorials, feature previews and interviews."}),e.jsxs("a",{href:"https://www.youtube.com/@chromaticui",target:"_blank",children:["Watch on YouTube",e.jsx(t,{})]})]})]}),e.jsxs("div",{className:"sb-section-item",children:[e.jsx("img",{src:E,alt:"A book",className:"sb-explore-image"}),e.jsx("p",{children:"Follow guided walkthroughs on for key workflows."}),e.jsxs("a",{href:"https://storybook.js.org/tutorials/",target:"_blank",children:["Discover tutorials",e.jsx(t,{})]})]})]}),`
`,e.jsx("style",{children:`
  ...
  `})]})}function W(i={}){const{wrapper:s}={...c(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(g,{...i})}):g(i)}export{t as RightArrow,W as default};
